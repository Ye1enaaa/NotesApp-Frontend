              ...
              <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                <div className="flex items-center justify-between p-4 md:p-5 border-b 
                  ...
                  hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto 
                    ...
                    dark:hover:text-white" onClick={onClose}>
                ...
                <form className="p-4 md:p-5" onSubmit={handleSubmit}>
                  <div className="grid gap-4 mb-4 grid-cols-2">
                    <div className="col-span-2">
                      ...
                      <input type="text" name="title" id="title" 
                        ...
                        dark:focus:border-primary-500" placeholder="Type note title" 
                        required="" />
                    </div>
                    <div className="col-span-2">
                  ...
                  <button type="submit" className="text-white inline-flex items-center 
                  ...
                  dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                    ...
                    d="M10 5a1 1 0 011 1v3h3a1 1 0 110 2h-3v3a1 1 0 11-2 0v-3H6a1 1 0 110-2h3V6a1 1 0 011-1z" clipRule="evenodd"></path></svg>
                    Add new note
                  </button>
                </form>
              </div>
